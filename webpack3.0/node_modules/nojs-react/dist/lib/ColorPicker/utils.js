...
var HsbToRgb = exports.HsbToRgb = function HsbToRgb(H, S, B) {
    //hsb模式转换为rgb模式
    var rgb = { R: 0, G: 0, B: 0 };
    H = H >= 360 ? 0 : H;
    S /= 100;
...
var RgbToHsb = exports.RgbToHsb = function RgbToHsb(R, G, B) {
    //rgb模式转换为hsb模式
...
var RgbToHex = exports.RgbToHex = function RgbToHex(R, G, B, prefix) {
    //rgb转16进制 prefix是否带#
    var hex,
        strHex = '',
...
var dealColor = exports.dealColor = function dealColor(color) {
